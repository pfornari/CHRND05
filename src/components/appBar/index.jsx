      ...
      <TouchableWithoutFeedback onPress={() => navigator.navigate("Todos")}>
        <View style={styles.appBarButton}>
          <Image
            style={[
              styles.buttonIcon,
              screen === "todos" && { tintColor: colors.primary },
            ]}
          ...
          <Text
            style={[
              styles.buttonText,
              screen === "todos" && { color: colors.primary },
            ]}
          >
            Tareas
          </Text>
      ...
      <TouchableWithoutFeedback onPress={() => setScreen("reminders")}>
        <View style={styles.appBarButton}>
          <Image
            style={[
              styles.buttonIcon,
              screen === "reminders" && { tintColor: colors.primary },
            ]}
          ...
          <Text
            style={[
              styles.buttonText,
              screen === "reminders" && { color: colors.primary },
            ]}
          >
            Recordatorios
          </Text>
      ...
      <TouchableWithoutFeedback onPress={() => setScreen("settings")}>
        <View style={styles.appBarButton}>
          <Image
            style={[
              styles.buttonIcon,
              screen === "settings" && { tintColor: colors.primary },
            ]}
          ...
          <Text
            style={[
              styles.buttonText,
              screen === "settings" && { color: colors.primary },
            ]}
          >
            Configuración
          </Text>
